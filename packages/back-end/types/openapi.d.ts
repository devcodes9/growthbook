...
export interface paths {
  ...
  "/metric-groups": {
    ...
    get: operations["getMetricGroups"];
    /** Create a metric group */
    post: operations["postMetricGroup"];
  };
  "/metric-group/{id}": {
    /** Update a metric group */
    put: operations["putMetricGroup"];
    /** Delete a metric group */
    delete: operations["deleteMetricGroup"];
  };
  "/metric-group/{id}/reorder": {
    /** Reorder metrics in a metric group */
    put: operations["putMetricGroupReorder"];
  };
  "/metric-group/{id}/remove/{metricId}": {
    /** Remove a metric from a metric group */
    delete: operations["removeMetricFromGroup"];
  };
}
...
export interface operations {
  ...
  putMetricGroupReorder: {
    ...
    requestBody: {
      content: {
        "application/json": {
          /** @description The index to move from */
          from: number;
  ...
  removeMetricFromGroup: {
    /** Remove a metric from a metric group */
    parameters: {
        /** @description Metric group id */
        /** @description Metric id to remove */
      path: {
        id: string;
        metricId: string;
      };
...
export type GetMetricGroupsResponse = operations["getMetricGroups"]["responses"]["200"]["content"]["application/json"];
export type PostMetricGroupResponse = operations["postMetricGroup"]["responses"]["200"]["content"]["application/json"];
export type PutMetricGroupResponse = operations["putMetricGroup"]["responses"]["200"]["content"]["application/json"];
export type DeleteMetricGroupResponse = operations["deleteMetricGroup"]["responses"]["200"]["content"]["application/json"];
export type PutMetricGroupReorderResponse = operations["putMetricGroupReorder"]["responses"]["200"]["content"]["application/json"];
export type RemoveMetricFromGroupResponse = operations["removeMetricFromGroup"]["responses"]["200"]["content"]["application/json"];
